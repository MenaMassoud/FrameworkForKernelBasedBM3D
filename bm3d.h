...
,   std::vector<float> &img_basic
,   std::vector<float> &img_basic_s
,   std::vector<float> &img_basic_c
,   std::vector<float> &img_basic_h
,   std::vector<float> &img_basic_v
,   std::vector<float> &img_basic_D135
,   std::vector<float> &img_basic_D45
,   const unsigned width
,   const unsigned height
,   const unsigned chnls
...
,   std::vector<float> &img_denoised
,   std::vector<float> &img_denoised_s
,   std::vector<float> &img_denoised_c
,   std::vector<float> &img_denoised_hor
,   std::vector<float> &img_denoised_ver
,   std::vector<float> &img_denoised_D135
,   std::vector<float> &img_denoised_D45
,   const unsigned width
,   const unsigned height
,   const unsigned chnls
